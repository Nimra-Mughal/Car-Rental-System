...
class booking:
    def __init__(self,root):
        ...
        lbltitle = Label(self.root, text="RENT A CAR", font=("times new roman", 18, "bold"), bg="black",fg="gold", bd=4, relief=RIDGE)
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Booking Details",font=("times new roman", 18, "bold"),padx=5)
        labelframeleft.place(x=5,y=50,width=425,height=550)

        lbl_brand_ref=Label(labelframeleft,text="Booking Id ",font=("times new roman", 13, "bold"),padx=2,pady=6)
        ...
        bname = Label(labelframeleft, text="Customer Name", font=("times new roman", 13, "bold"), padx=2, pady=6)
        bname.grid(row=2, column=0, sticky=W)
        txt_bname = ttk.Entry(labelframeleft,textvariable=self.var_cust_name, width=29, font=("times new roman", 13, "bold"))
        ...
        labelbrand.grid(row=4, column=0, sticky=W)
        self.combo_brand = ttk.Combobox(labelframeleft,textvariable=self.var_brand_name,  font=("times new roman", 13, "bold"),width=27, state="readonly")
        self.combo_brand['values'] = ("Toyota", "Suzuki", "Corolla", "Kiya")
        self.combo_brand.current(0)
        self.combo_brand.grid(row=5, column=0)

        labelcar = Label(labelframeleft, text="Cars", font=("times new roman", 12, "bold"), padx=2, pady=6)
        labelcar.grid(row=6, column=0, sticky=W)
        self.combo_car = ttk.Combobox(labelframeleft,textvariable=self.var_car_name, font=("times new roman", 13, "bold"), width=27, state="readonly")
        self.combo_car['values'] = ("MBW", "HONDA", "Mera")
        self.combo_car.current(0)
        self.combo_car.grid(row=7, column=0)
        ...
        btnAdd=Button(btn_frame,text="Book",command=self.add_data,font=("times new roman",13, "bold"),bg="black",fg="gold",width=9)
        ...
        self.Cust_Details_Table=ttk.Treeview(details_table,column=("ref","cname","brandname","carname"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.Cust_Details_Table.heading("cname",text=" CustomerName")
        self.Cust_Details_Table.heading("brandname",text=" BrandName")
        self.Cust_Details_Table.heading("carname",text=" CarName")


        self.Cust_Details_Table["show"]="headings"
        self.Cust_Details_Table.column("ref",width=10)
        self.Cust_Details_Table.column("cname",width=100)
        self.Cust_Details_Table.column("brandname",width=100)
    ...
    def add_data(self):
        if self.var_brand_name.get()=="" :
            ...
            try:
                ...
                cursor = con.cursor()
                cursor.execute(
                    "insert into booking (ref,cname,brandname,carname) values (%s,%s,%s,%s)",
                    (
                        self.var_ref.get(),
