...
class cars:
    def __init__(self,root):
        ...
        lbltitle = Label(self.root, text="OUR CARS DETAILS", font=("times new roman", 18, "bold"), bg="black",fg="gold", bd=4, relief=RIDGE)
        ...
        labelframeleft = LabelFrame(self.root, bd=2, relief=RIDGE, text="Available Cars",font=("times new roman", 18, "bold"), padx=5)
