...
class qr:
    def __init__(self,root):
        self.root=root
        self.root.title("Quiries")
        self.root.geometry("1370x610+225+218")

        lbltitle = Label(self.root, text="QUIRIES DETAILS", font=("times new roman", 18, "bold"), bg="black",fg="gold", bd=4, relief=RIDGE)
        ...
        labelframeleft = LabelFrame(self.root, bd=2, relief=RIDGE, text="Quiries",font=("times new roman", 18, "bold"), padx=5)
        ...
        details_table.place(x=50, y=80, width=540, height=350)

        # scroll_x = ttk.Scrollbar(details_table, orient=HORIZONTAL)
        # scroll_y = ttk.Scrollbar(details_table, orient=VERTICAL)

        self.Cust_Details_Table = ttk.Treeview(details_table, column=("name", "email","msg"))
        ...
        self.Cust_Details_Table.heading("msg", text=" Message")


        self.Cust_Details_Table["show"] = "headings"
        self.Cust_Details_Table.column("name")
        self.Cust_Details_Table.column("email")
        self.Cust_Details_Table.column("msg")
